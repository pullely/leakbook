 ...
 * signature verifier for Leakbook outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Leakbook webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Leakbook webhook delivery.
 *
