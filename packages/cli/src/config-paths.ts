...
//   - `~/.config/leakbook/credentials.json` (0600)
//   - `~/.config/leakbook/config.json`     (0644)
//
// Override via `LEAKBOOK_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/leakbook` everywhere
