// `leakbook webhook verify` — local cryptographic verification of a
// Leakbook outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `leakbook login`.
