...
// `@saas/sdk` client class name (`Leakbook`) is intentionally NOT part of
...
export const CLI_BIN = "leakbook";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Leakbook";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.leakbook.app";
