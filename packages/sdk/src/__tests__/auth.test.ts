...
//   - LeakbookError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Leakbook {
  return new Leakbook({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Leakbook class", () => {
