// Typed error hierarchy for the Leakbook SDK.
//
...
// codes (forward compatibility) fall back to the generic `LeakbookError`
...
export interface LeakbookErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof LeakbookError`
 * still matches.
 */
export class LeakbookError extends Error {
  ...
  constructor(init: LeakbookErrorInit) {
    super(init.envelope.message);
    this.name = "LeakbookError";
...
export class BadRequestError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export class UnauthenticatedError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export class ForbiddenError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export class NotFoundError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export class ConflictError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export class ValidationError extends LeakbookError {
...
export class PreconditionFailedError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export class UnsupportedError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export class InternalError extends LeakbookError {
  constructor(init: LeakbookErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends LeakbookErrorInit {
...
export class RateLimitError extends LeakbookError {
...
/**
 * Decode an HTTP `Response` into the appropriate `LeakbookError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `LeakbookError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new LeakbookError(init);
  }
}

function decodeRateLimit(
  init: LeakbookErrorInit,
  response: Response,
): RateLimitError {
