...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Leakbook web console.
...
- Per-env Cloudflare Pages projects: `leakbook-web-console-next-{dev,stage,prod}`
